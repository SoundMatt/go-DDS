...
| gofusa         | go-FuSa v0.47.0 full lifecycle (§20): check + 100% trace (traced AND tested) + cyber + vuln + qualify |
| relay-conform  | RELAY v1.14 conform --strict + interop --protocol DDS --strict |
